        ...
        <div className="header__layout">
            ...
            <div className="header__layout-wrapper">
                <div className="header__layout-left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17.977" height="17.686" viewBox="-4.311 -0.833 17.977 17.686"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><circle cx="3.708" cy="7.13" r="7.348"></circle><path d="M12.891 16.313l-3.994-3.994"></path></g></svg>
                    ...
                    <div className="layout-mid-bot">
                        <ul>
                            {HeaderData.map((item, index) => {
                                return (
                                    <li key={index} >
                                        <NavLink activeClassName='teee' className={item.cName} to={item.path}>{item.title}</NavLink>
                                    </li>
                                )
                            })}
                            <li>
