          ...
          <>
            ...
            <div className="contact__questions">
              <div className="contact__questions-left">
                ...
                <p className="text-p">Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat
              ...
              <div className="contact__questions-right">
                <div className="question-right-input">
                  ...
                  <textarea style={{paddingTop: '20px', paddingLeft: '10px'}} className="input-commnents" cols="30"
