      ...
      <div className="detail__container">
        ...
        <div className="detail__container-right">
          <div className="detail-right-content">
            ...
            <p className='detail-sub'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
            <div className="detail-btn">
              <div style={{ userSelect: 'none', cursor: 'pointer', margin: '25px 0px ' }} onClick={() => { addToCart(current.id); notify() }} className="detail-btn-add">Add To Cart</div>
