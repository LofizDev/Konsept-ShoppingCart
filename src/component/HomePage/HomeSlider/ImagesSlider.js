              ...
              return (<div key={index}>
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="35" viewBox="23.25 0 10.749 19.997">
                      <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                            d="M33.232 19.181l-9.215-9.215L33.232.75"></path>
                 </svg>
              </span>
                                  <span className="right-arrow" onClick={nextSlide}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" class="rsvg" height="35"
                   viewBox="23.25 0 10.749 19.997">
                 <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" fill="none"
                       d="M33.232 19.181l-9.215-9.215L33.232.75"></path>
              </svg>
              </span>
