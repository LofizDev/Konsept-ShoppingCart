...
function SliderAnimation () {
    ...
    return (
        <div className="content__animation">
            ...
            <svg className='sliderpath' xmlns="http://www.w3.org/2000/svg" width="137.982" height="135"><path class="qodef-quote-svg-blob" fill="#dfe8ec" d="M61.886 7.875S6.369-12.676 1.874 14.725c-4.496 27.4 7.492 121.593 56.016 107.322s62.795-37.105 50.235-68.503C95.566 22.145 75.158 11.87 61.886 7.875z"></path><circle className='cirani' fill="none" stroke="#8B8B8B" strokeMiterlimit="10" cx="75.449" cy="61.993" r="61.4"></circle><path fill="#211F1F" d="M63.553 69.24c1.641-1.549 2.916-3.439 3.829-5.674a18.482 18.482 0 001.367-7.042c0-1.184-.137-2.369-.41-3.555l5.879-.957c.273 1.186.41 2.371.41 3.555 0 3.1-.73 6.132-2.188 9.093-1.459 2.963-3.374 5.4-5.743 7.314l-3.144-2.734zm12.716 0c1.641-1.549 2.917-3.439 3.829-5.674a18.482 18.482 0 001.367-7.042c0-1.184-.137-2.369-.41-3.555l5.879-.957c.273 1.186.41 2.371.41 3.555 0 3.1-.73 6.132-2.188 9.093-1.459 2.963-3.374 5.4-5.743 7.314l-3.144-2.734z"></path></svg>
